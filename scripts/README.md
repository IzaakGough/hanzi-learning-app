...
- binary and ternary IDS operators are supported for this v1 slice
...
- the CHISE normalizer targets extracted `IDS-UCS` rows and intentionally does not vendor the full upstream dataset into the repo
